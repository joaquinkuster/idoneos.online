...
- **Postcondición(es)**: El curso queda en baja.
- **Excepciones**:
...
- **Precondición(es)**: Debe existir al menos un curso con alguna cohorte con inscripción abierta.
- **Flujo de eventos**:
...
- **Postcondición(es)**: La cohorte queda en baja (Cancelada).
- **Excepciones**:
...
| 3 | El alumno puede, alternativamente: (a) consultar el cronograma del curso; (b) buscar las unidades del curso para acceder al contenido de una de ellas; (c) consultar los participantes del curso; (d) consultar sus propias calificaciones. |
...
| 6 | Si el alumno seleccionó una unidad, el sistema verifica que se encuentre habilitada según su avance secuencial (el progreso de la unidad anterior figura como completado, o es la primera unidad del curso). |
...
| 4 | El actor confirma la baja y, si lo desea, ingresa el motivo. |
...
| 5 | El alumno selecciona MODO como medio de pago. |
...
| 8 | El alumno escanea el código QR (o abre la app elegida desde el celular) y completa el pago desde ahí, con la tarjeta o el saldo de cuenta que prefiera. |
...
| 5 | El alumno selecciona una opción de respuesta para cada una de las preguntas. |
| 6 | El alumno confirma la entrega del intento. |
...
| 4 | El actor modifica el título, la fecha, la hora o la duración estimada. |
...
| 5 | El docente carga los datos de conexión en OBS y comienza a transmitir. |
...
| 4 | El actor confirma la generación, con o sin el guión adicional. |
...
| 3 | El actor confirma la generación. |
...
| 4 | El actor adjunta o toma la foto, y graba un audio de uno a dos minutos leyendo el guión de ejemplo con su voz. |
| 5 | El sistema muestra los términos y condiciones de uso del clon y solicita su aceptación. |
| 6 | El actor acepta los términos y condiciones. |
...
- **Postcondición(es)**: El docente queda con su avatar_id y voice_id registrados, habilitado para generar clases con Clon de IA.
- **Excepciones**:
